...
.md-input-placeholder.md-float:not(.md-empty) .md-placeholder-required, .md-float.md-focused .md-placeholder-required {
  color: #ff4081; }
...
md-progress-circle path {
  stroke: #3949ab; }

md-progress-circle[color='accent'] path {
  stroke: #d81b60; }

md-progress-circle[color='warn'] path {
  stroke: #e53935; }
